Shader "Unlit/FireBallShader"
{
    Properties
    {
        ...
        _Zoom ("Zoom", Float) = 5.0
        _AnimationSpeedMultiplier ("Animation Speed", Float) = 1.0
    }
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 _MainTex_ST;
            float _Zoom = 5.0;
            float _AnimationSpeedMultiplier = 1.0;
            ...
            {
                float noise = Turbulence(position * NoiseFrequency + Animation * _Time.y * _AnimationSpeedMultiplier, 0.1, 1.5, 0.03) *
                    NoiseAmplitude;
